...
public class VorbisCodebook {
	...
	VorbisCodebook() {
		...
		if (var1) {
			...
			for (var3 = VorbisSample.readBits(5) + 1; var2 < this.entries; ++var3) {
				int var4 = VorbisSample.readBits(class194.iLog(this.entries - var2));
		...
		if (var2 > 0) {
			...
			this.field346 = new int[var7];

			int var8;
			for (var8 = 0; var8 < var7; ++var8) {
				this.field346[var8] = VorbisSample.readBits(var5);
			}
			...
			if (var2 == 1) {
				for (var8 = 0; var8 < this.entries; ++var8) {
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) {
						...
						float var13 = (float)this.field346[var12] * var16 + var15 + var9;
				...
				for (var8 = 0; var8 < this.entries; ++var8) {
					...
					for (var11 = 0; var11 < this.dimensions; ++var11) {
						float var17 = (float)this.field346[var10] * var16 + var15 + var9;
	...
	@ObfuscatedName("j")
	float[] method957() {
		return this.field345[this.method958()];
	}
