...
public class VorbisFloor {
	...
	static {
		field260 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field252 = new int[var5];
			this.field252[0] = 0;
			this.field252[1] = 1 << var4;
			var5 = 2;
			...
			for (var6 = 0; var6 < var2; ++var6) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field252[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field259 == null || field259.length < var5) {
				field259 = new int[var5];
				field254 = new int[var5];
	...
	@ObfuscatedName("f")
	int method671(int var1, int var2, int var3, int var4, int var5) {
		int var6 = var4 - var2;
		int var7 = var3 - var1;
	...
	@ObfuscatedName("j")
	void method669(int var1, int var2, int var3, int var4, float[] var5, int var6) {
		int var7 = var4 - var2;
		int var8 = var3 - var1;
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field259[var1];
			int var5 = field254[var1];
			boolean var6 = field255[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field259[var7];
				if (var8 < var4) {
					field259[var3] = var8;
					field254[var3] = field254[var7];
					field255[var3] = field255[var7];
					++var3;
					field259[var7] = field259[var3];
					field254[var7] = field254[var3];
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field252.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field259[var3] = this.field252[var3];
			}

			var3 = field260[this.multiplier - 1];
			int var4 = class194.iLog(var3 - 1);
			field254[0] = VorbisSample.readBits(var4);
			field254[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method958();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field254[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method958() : 0;
				}
			}
	...
	@ObfuscatedName("t")
	void method673(float[] var1, int var2) {
		int var3 = this.field252.length;
		int var4 = field260[this.multiplier - 1];
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method681(field259, var6);
			var8 = method667(field259, var6);
			var9 = this.method671(field259[var7], field254[var7], field259[var8], field254[var8], field259[var6]);
			var10 = field254[var6];
			int var11 = var4 - var9;
			...
			if (var10 != 0) {
				...
				field255[var6] = true;
				if (var10 >= var13) {
					field254[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field254[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field255[var6] = false;
				field254[var6] = var9;
		...
		var6 = 0;
		var7 = field254[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field255[var8]) {
				var9 = field259[var8];
				var10 = field254[var8] * this.multiplier;
				this.method669(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("l")
	static int method681(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
	...
	@ObfuscatedName("q")
	static int method667(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
